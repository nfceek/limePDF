...
// ----- Form Specific Parameters-------------------------------------------------------
	...
	//  Set text for cell(s)
		$pdfText = "You can also export 1D barcodes in other formats (PNG, SVG, HTML). Check the examples inside the barcodes directory.\n";
...
// print a message
$pdf->MultiCell(70, 50, $pdfText, 0, 'J', false, 1, 125, 30, true, 0, false, true, 0, 'T', false);
$pdf->setY(30);
