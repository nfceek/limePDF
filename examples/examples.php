...
<body>
  ...
  <aside>
    <h2>Navigation</h2>
    <p>Quick links, docs, or filters here.</p>
  </aside>
  ...
  <section>
    ...
    <details open>
      <summary>Basic Documents</summary>
      <ul>
        <li><a href="legacy/example_001.php" target="_blank">Simple PDF with Header & Footer</a></li>
        <li><a href="legacy/example_002.php" target="_blank">Simple PDF without Header/Footer</a></li>
    ...
    <details>
      ...
      <ul>
        <li><a href="legacy/example_004.php" target="_blank">Cell Stretching</a></li>
    ...
    <details>
      ...
      <ul>
        ...
        <li><a href="legacy/example_030.php" target="_blank">Colour Gradients</a></li>
        <li><a href="legacy/example_031.php" target="_blank">Pie Chart Graphic</a></li>
    ...
    <details>
      <summary>Fonts & Languages</summary>
      <ul>
        <li><a href="legacy/example_018.php" target="_blank">Persian/Arabic RTL</a></li>
        <li><a href="legacy/example_019.php" target="_blank">Non-Unicode Config</a></li>
        <li><a href="legacy/example_033.php" target="_blank">Mixed Font Types</a></li>
        <li><a href="legacy/example_038.php" target="_blank">NON-embedded CID-0 CJK</a></li>
        <li><a href="legacy/example_055.php" target="_blank">Font Dump</a></li>
      </ul>
    </details>
  </section>
  ...
  <!-- Barcode Examples -->
  <section>
    <h2>Barcode Examples</h2>

    <details>
      <summary>1D Barcodes</summary>
      <ul>
        <li><a href="barcodes/example_1d_html.php" target="_blank">1D Barcode (HTML)</a></li>
        <li><a href="barcodes/example_1d_png.php" target="_blank">1D Barcode (PNG)</a></li>
        <li><a href="barcodes/example_1d_svg.php" target="_blank">1D Barcode (SVG)</a></li>
        <li><a href="barcodes/example_1d_svgi.php" target="_blank">1D Barcode (Inline SVG)</a></li>
      </ul>
    </details>

    <details>
      <summary>2D Barcodes - Datamatrix</summary>
      <ul>
        <li><a href="barcodes/example_2d_datamatrix_html.php" target="_blank">Datamatrix (HTML)</a></li>
        <li><a href="barcodes/example_2d_datamatrix_png.php" target="_blank">Datamatrix (PNG)</a></li>
        <li><a href="barcodes/example_2d_datamatrix_svg.php" target="_blank">Datamatrix (SVG)</a></li>
        <li><a href="barcodes/example_2d_datamatrix_svgi.php" target="_blank">Datamatrix (Inline SVG)</a></li>
      </ul>
    </details>

    <details>
      <summary>2D Barcodes - PDF417</summary>
      <ul>
        <li><a href="barcodes/example_2d_pdf417_html.php" target="_blank">PDF417 (HTML)</a></li>
        <li><a href="barcodes/example_2d_pdf417_png.php" target="_blank">PDF417 (PNG)</a></li>
        <li><a href="barcodes/example_2d_pdf417_svg.php" target="_blank">PDF417 (SVG)</a></li>
        <li><a href="barcodes/example_2d_pdf417_svgi.php" target="_blank">PDF417 (Inline SVG)</a></li>
      </ul>
    </details>

    <details>
      <summary>2D Barcodes - QRCode</summary>
      <ul>
        <li><a href="barcodes/example_2d_qrcode_html.php" target="_blank">QRCode (HTML)</a></li>
        <li><a href="barcodes/example_2d_qrcode_png.php" target="_blank">QRCode (PNG)</a></li>
        <li><a href="barcodes/example_2d_qrcode_svg.php" target="_blank">QRCode (SVG)</a></li>
        <li><a href="barcodes/example_2d_qrcode_svgi.php" target="_blank">QRCode (Inline SVG)</a></li>
      </ul>
    </details>
  </section>
  ...
  <aside>
    <h2>Resources</h2>
    <p>Useful links, notes, or ads here.</p>
  </aside>
